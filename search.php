            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    ?>
                        ...
                        $sql = "SELECT post.post_id, post.title, post.description, post.post_date, category.category_name, user.username, post.category, post.post_img, post.author, post.author FROM post  
                    ...
                    <?php
                        ...
                        if (mysqli_num_rows($result1) > 0) {
                            ...
                            if ($total_page > $page) {
                                echo "<li><a href='index.php?search=" . $search_term . "&search=" . $search_term . "&page=" . ($page + 1) . "'>Next</a></li>";
                            }
                            echo "</ul";
                            // PAGINATION ENDS
                        }
